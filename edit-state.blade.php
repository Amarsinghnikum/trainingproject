            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="tab-content">
                        ...
                        <form action="{{url('/update-state/'.$states->id)}}" method="post">
                        @csrf
                        @method('PUT')
                            <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <label for="">State Code</label>
                                    <input type="text" class="form-control" name="code" value="{{ $states->code }}">
                                </div>
                            </div> 
                            ...
                            <label for="">Country</label>
                                <input type="text" class="form-control" name="country" value="{{ $states->country }}">
                            </div>
                            </div>
                           </div>
