    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Update Customer</a></li>                       
                    </ul>
                    <div class="tab-content">
                        
                        <div class="tab-pane body active" id="about">
                            <form action="{{url('/update-customer/'.$customers->id)}}" method="post">
                            @csrf  
                            @method('PUT')
                            <div class="row">
                            <div class="col-lg-3 col-md-8">
                                ...
                                <label for=""><b>CUSTOMER NAME</b></label>
                                    <input type="text" class="form-control" name="cnt_person" value="{{$customerss->cnt_person}}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-8">
                                <div class="form-group">
                                <label for=""><b>CUSTOMER ADDRESS</b></label>
                                    <input type="text" class="form-control" name="address" value="{{$customerss->address}}">
                                </div>
                            </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="col-lg-3 col-md-8">
                               <label for=""><b>STATE</b></label>
                                <select class="selectpicker" name="cl_state">
                                <option value="0">--Select--</option>
                                @foreach($customer as $key=>$val)
                                <option value="{{$val->cl_state}}" {{$val->cl_state?'selected':''}}>{{$val->cl_state}}</option>
                                @endforeach
                                </select>
                            </div> 
                            </div> 
                           ...
                           <label for=""><b>CITY</b></label>
                                <select class="selectpicker" name="cl_city">
                                <option value="0">--Select--</option>
                                @foreach($customer as $key=>$val)
                                <option value="{{$val->cl_city}}" {{$val->cl_city?'selected':''}}>{{$val->cl_city}}</option>
                                @endforeach
                                </select>
                            </div>
                            </div>
                            <div class="col-lg-3 col-md-8">
                                ...
                                <label for=""><b>PIN CODE</b></label>
                                    <input type="text" class="form-control" name="pin_code" value="{{$customerss->pin_code}}">
                                </div>
                            </div>
                           </div>
                           <div class="row">
                           ...
                           <label for=""><b>TYPE</b></label>
                                ...
                                <option value="0">--Select--</option>
                                @foreach($customer as $key=>$val)
                                <option value="{{$val->type}}" {{$val->type?'selected':''}}>{{$val->type}}</option>
                                @endforeach
                                </select>
                            </div>
                           </div>
