    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">State List</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">Add State</a></li>                        
                    </ul>
                    <div class="tab-content">
                                    ...
                                    <table class="table table-hover m-b-0" id="myTable">
                                        ...
                                        <tbody>
                                            <!-- <tr>
                                                ...
                                                <td>{{$val->code}}</td>
                                                <td>{{$val->country}}</td>
                                                <td><a href="{{ url('edit-state/'.$val->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                                <td><a href="{{ url('delete-state/'.$val->id) }}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                            </tr> -->
                                        </tbody>
                                        @php $i=$i+1; @endphp
                                        @endforeach
                        ...
                        <form action="{{url('/insert-state')}}" method="post">
                        @csrf
                            <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <label for="">State Code</label>
                                    <input type="text" class="form-control" name="code" placeholder="Enter State Code">
                                </div>
                            </div> 
                            ...
                            <!-- <div class="row clearfix">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-info btn-round">Add State</button>
                                <hr>
                                </div>
                            </div>
                        </div>     
...
<script>
    ...
    columns: [
        ...
        { data: "code", "orderable": false, "visible": true },
        { data: "country", "orderable": false, "visible": true },
