    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">COMPANY LIST</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">ADD COMPANY</a></li>                        
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane body" id="Account">
                            ...
                            <div class="col-lg-3 col-md-8">
                                ...
                                <label for=""><b>COMPANY NAME</b></label>
                                    <input type="text" class="form-control" name="co_name" placeholder="Enter Company Name">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-8">
                                <div class="form-group">
                                <label for=""><b>COMPANY ADDRESS</b></label>
                                    <input type="text" class="form-control" name="co_address" placeholder="Enter Company Address">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-8">
...
<script>
    ...
    columns: [
        ...
        { data: "co_address", "orderable": false, "visible": true },
