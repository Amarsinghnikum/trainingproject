    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Category List</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">Add Category</a></li>                        
                    </ul>
                    <div class="tab-content">
                                    ...
                                    <table class="table table-hover m-b-0" id="myTables">
                                        ...
                                        <tbody>
                                            <!-- <tr>
                                                ...
                                                <td><a href="{{url('/edit-category/'.$val->id)}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                                <td><a href="{{url('/delete-category/'.$val->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                            </tr> -->
                                        </tbody>
                                        @php $i=$i+1; @endphp
                                        @endforeach
                    ...
                    <form action="{{url('/insert-category')}}" method="post">
                        @csrf
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="cat_code" placeholder="Enter Category code">
                                </div>
                            </div> 
                           ...
                           <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="cat_des" >
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="cat_remark" >
                                </div>
                            </div> 
                           </div>
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    <div class="checkbox">
                                        <input id="procheck2" name="status" type="checkbox">
...
<script>
    ...
    columns: [
        ...
        { data: "cat_name", "orderable": false, "visible": true },
