                ...
                <div class="col-xs-6" style="border:0px solid gray">
                    ...
                    <label for=""></label>
                        ...
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-4 col-form-label" style="color:#666;">MAJOR BOM ITEM :</label>
                            <div>
                                <div><b>{{$productimage->product_cat}}</b></div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-4 col-form-label" style="color:#666;">ASSY INSTRUCTIONS :</label>
                            <div>
                        ...
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-4 col-form-label" style="color:#666;">LITERATURE :</label>
                            <div>
                        ...
                        <label for="inputPassword" style="margin:25px;margin-top: 50px;">IMAGE 1</label>
                        <label for="inputPassword" style="margin-left:45px;">IMAGE 2</label>
                        <label for="inputPassword" style="margin-left:70px;">IMAGE 3</label>
                        <label for="inputPassword" style="margin-left:75px;">IMAGE 4</label>
                       
                        </div>
                        <div class="form-group">
                            <div class="row">
                            <div>
                                <img src="{{ asset('assets2/image-1/'.$productimage->image1)}}" style="margin:20px;margin-top: -10px;" width="100px" height="100px"/>
                            </div>
                            
                            <div>
                                <img src="{{ asset('assets2/image-2/'.$productimage->image2)}}" style="margin:20px;margin-top: -10px;" width="100px" height="100px"/>
                            </div>
                            
                            <div>
                                <img src="{{ asset('assets2/image-3/'.$productimage->image3)}}" style="margin:20px;margin-top: -10px;" width="100px" height="100px"/>
                            </div>
                            
                            <div>
                                <img src="{{ asset('assets2/image-4/'.$productimage->image4)}}" style="margin:20px;margin-top: -10px;" width="100px" height="100px"/>
                            </div>
                            </div>
                        </div>
                </div> 
