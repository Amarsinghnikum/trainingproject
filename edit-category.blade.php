    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Update Category</a></li>                       
                    </ul>
                    <div class="tab-content">
                        
                        <div class="tab-pane body active" id="about">
                        <form action="{{url('/update-category/'.$getCategory->id)}}" method="post">
                        @csrf
                        @method('PUT')
                            <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <label for="">City Name</label>
                                    <input type="text" class="form-control" id="cat_name" name="cat_name" value="{{$getCategory->cat_name}}">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                <label for="">City Code</label>
                                    <input type="text" class="form-control" id="cat_code" name="cat_code" value="{{$getCategory->cat_code}}">
                                </div>
                            </div> 
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                <label for="">City Name</label>
                                    <input type="text" class="form-control" id="cat_des" name="cat_des" value="{{$getCategory->cat_des}}">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                <label for="">City Code</label>
                                    <input type="text" class="form-control" id="cat_remark" name="cat_remark" value="{{$getCategory->cat_remark}}">
                                </div>
                            </div> 
                           </div>
                           <div class="col-md-12">
                                    <div class="checkbox">
                                        <input id="procheck2" type="checkbox" name="status" id="status" <?php if($getCategory->status=='1'){ echo "checked"; } ?> >
                                        <label for="procheck2">Status</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-info btn-round">Update State</button>
                                <hr>
                                </div>
                            </div>
                        </div>     
...
<script>
  ...
  $.ajaxSetup({
    ...
    if(cat_name==""){
      document.getElementById('category_name_error').innerHTML="Please enter your category.";
      return false;
    }
    ...
    var category_id=$("#category_id").val();
     ...
     var status = document.getElementById('status').checked;
      if(status == true){
        status = document.getElementById('status_value').value="1";
      }
       if(status== false){
        status = document.getElementById('status_value').value="0";
      }
    
      $.ajax
      ({
        type:'post',
        url:"{{url('saveEditCategory')}}",
        data:{
