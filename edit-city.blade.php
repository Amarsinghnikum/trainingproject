    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Update City</a></li>                      
                    </ul>
                    <div class="tab-content">
                        
                        <div class="tab-pane body active" id="about">
                        <form action="{{url('/update-city/'.$cities->id)}}" method="post">
                        @csrf
                        @method('PUT')
                            <div class="row">
                            <div class="col-lg-6 col-md-12">
                              <label for="">State Name</label>
                                ...
                                @foreach($state as $key=>$val)
                                   <option value="{{$val->state}}" {{$val->state?'selected':''}}>{{ $val->state }}</option>
                                @endforeach
                                </select>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                ...
                                <label for="">City Name</label>
                                    <input type="text" class="form-control" name="city" value="{{ $cities->city }}">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                <label for="">City Code</label>
                                    <input type="text" class="form-control" name="city_code" value="{{ $cities->city_code }}">
                                </div>
                            </div> 
                           </div>
                           <div class="col-md-12">
                                    <div class="checkbox">
                                        <input id="procheck2" type="checkbox" name="status" value="status" {{$cities->status=="1"?"Checked":""}}>
