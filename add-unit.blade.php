    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">UNIT LIST</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">ADD UNIT</a></li>                        
                    </ul>
                    <div class="tab-content">
                    ...
                    <form action="{{url('/insert-unit')}}" method="post">
                        @csrf
                            <div class="row">
                           ...
                           <div class="row">
                            <div class="col-lg-10 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label for=""></label>
                                      <textarea class="form-control" name="unit" ></textarea>
                                    </div>
                                </div>
                            </div> 
                           </div>
...
<script>
    ...
    columns: [
        ...
        { data: "group_code", "orderable": false, "visible": true },
