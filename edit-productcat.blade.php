                ...
                <div class="card">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane body active" id="about">
                            <form action="{{ url('/update-productcat/'.$productcat->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <label for=""><b>GROUP</b></label>
                                    <input type="text" class="form-control" name="group_name" value="{{$productcate->group_name}}">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                <label for=""><b>GROUP SNO</b></label>
                                    <input type="text" class="form-control" name="group_sno" value="{{$productcate->group_sno}}">
                                </div>
                            </div> 
