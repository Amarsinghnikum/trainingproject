    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Update Drawing Category</a></li>                       
                    </ul>
                    <div class="tab-content">
                        
                        <div class="tab-pane body active" id="about">
                        <form action="{{url('/update-drawing/'.$drawings->id)}}" method="post">
                        @csrf
                        @method('PUT')
                            <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                @foreach($group as $item)
                                  <option value="{{$item->group_name}}" {{$drawing->group_name==$item->group_name?'selected':''}}>{{$item->group_name}}</option>
                                @endforeach
                                </select>
                                </div>
                            </div>
                           ...
                           <div class="row">
                            <div class="col-lg-10 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label for=""></label>
                                      <textarea class="form-control" name="remark">{{$drawing->remark}}</textarea>
                                    </div>
                                </div>
                            </div> 
                           </div>
