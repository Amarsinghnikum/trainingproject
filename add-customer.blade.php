    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">CUSTOMER LIST</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">ADD CUSTOMER</a></li>                        
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane body" id="Account">
                            ...
                            <div class="col-lg-3 col-md-8">
                                ...
                                <label for=""><b>CUSTOMER NAME</b></label>
                                    <input type="text" class="form-control" name="cnt_person">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-8">
                                <div class="form-group">
...
<script>
    ...
    columns: [
        ...
        { data: "cnt_person", "orderable": false, "visible": true },
        { data: "client_code", "orderable": false, "visible": true },
        { data: "co_name", "orderable": false, "visible": true },
        { data: "address", "orderable": false, "visible": true },
        { data: "type", "orderable": false, "visible": true },
