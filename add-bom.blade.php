...
<link rel="stylesheet" type="text/css" href="{{ url('/assets/css/datatables/jquery.dataTables.css') }}"/>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">BOM LIST</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">ADD BOM</a></li>                        
                    </ul>
                    <div class="tab-content">
                                    ...
                                    <table class="table table-hover m-b-0" id="myTable">
                                        <thead>
                                            <tr>                                       
                                                ...
                                                <th>SUPPL CODE</th>
                                                <th>LINE OF ITEMS</th>
                                                <th>INCLUDE ITEM QTY</th>
                                                <!-- <th>UNIT</th> -->
                                                <th>ACTION</th>
                                            </tr>
                                        </thead>
                                        @php $i=1; @endphp
                                        @foreach($bomitem as $val=>$key)
                                        <tbody>
                                            <!-- <tr>
                                                <td><span class="list-name">{{$i}}</span></td>
                                                <td>{{$key->bom_itemname}}</td>
                                                <td>{{$key->bom_supplcode}}</td>
                                                <td>Line of items</td>
                                                <td>include item qty</td>
                                                <td>{{$key->unit}}</td>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                 <div class="col-md-12">
                                    <form action="{{url('/insert-bom')}}" method="post">
                                        @csrf
                                              ...
                                              <div class="row">
                                                   <div class="col-sm-3">
                                                        <div class="form-group">
                                                          ...
                                                          <input type="text" name="bom_supplcode" class="form-control">
                                                            @if (!empty($errors))
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="form-group">
                                                          ...
                                                          <input type="text" name="bom_itemname" class="form-control">
                                                        @if (!empty($errors))
...
<script>
    ...
    columns: [
        ...
        { data: "bom_itemname", "orderable": false, "visible": true },
        { data: "bom_supplcode", "orderable": false, "visible": true },
        { data: "qty", "orderable": false, "visible": true },
        { data: "unit", "orderable": false, "visible": true },
