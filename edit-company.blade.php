    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Update Product Category</a></li>                       
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane body active" id="about">
                            ...
                            <div class="col-lg-3 col-md-8">
                                ...
                                <label for=""><b>COMPANY NAME</b></label>
                                    <input type="text" class="form-control" name="co_name" value="{{$companies->co_name}}">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-8">
                                <div class="form-group">
                                <label for=""><b>COMPANY ADDRESS</b></label>
                                    <input type="text" class="form-control" name="co_address" value="{{$companies->co_address}}">
                                </div>
                            </div>
                           ...
                           <label for=""><b>STATE</b></label>
                                ...
                                <option value="0">--Select state--</option>companies
                                @foreach($state as $item)
                                <option value="{{$item->state}}" {{$item->state?'selected':''}}>{{$item->state}}</option>
                                @endforeach
                                </select>
                            </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-8">
                                ...
                                <label for=""><b>PIN CODE</b></label>
                                    <input type="text" class="form-control" name="pin_code" value="{{$companies->pin_code}}">
                                </div>
                            </div>
                           </div>
                           <div class="row">
                           ...
                           <label for=""><b>REMARK</b></label>
                               <textarea name="remark" class="form-control">{{$companies->remark}}</textarea>
                            </div>
                           </div>
                           <label for=""></label>
                                <div class="col-md-12">
