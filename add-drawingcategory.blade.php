    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">DRAWING CATEGORY LIST</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">ADD DRAWING CATEGORY</a></li>                        
                    </ul>
                    <div class="tab-content">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover m-b-0" id="myTable">
                                        <thead>
                                            <tr>              
                                                <th>S.N</th>
                                                <th>DRAWING CATEGORY NAME</th>
                                                <th>EDIT</th>
                                                <th>STATUS</th>
                                            </tr>
                                        </thead>
                                        @php $i=1; @endphp
                                        @foreach($drawings as $val=>$key)
                                        <tbody>
                                            <!-- <tr>
                    ...
                    <form action="{{url('/insert-drawing')}}" method="post">
                        @csrf
                            <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                <label for="">DRAWING CATEGORY</label>
                                <select class="selectpicker" name="group_name">
