    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#about">Product Category</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Account">Add Product Category</a></li>                        
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane body" id="Account">
                            <form action="{{ url('/insert-productcat') }}" method="post">
                            @csrf
                            <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                <label for=""><b>GROUP SNO</b></label>
                                    <input type="text" class="form-control" name="group_sno">
                                </div>
                            </div> 
...
<script>
    ...
    columns: [
        ...
        { data: "group_name", "orderable": false, "visible": true },
        { data: "group_sno", "orderable": false, "visible": true },
