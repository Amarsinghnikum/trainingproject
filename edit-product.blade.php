...
function del_more_bom_item1(name,id){
  if(name == 'attributes'){         
      if(document.getElementById('attributes_value_div_bom_item_'+id).style.display == "block"){
      decr1 = id-1;
      document.getElementById("bom_item"+id).value="";
...
function del_more_vendor1(name,id){
  if(name == 'attributes'){         
      if(document.getElementById('attributes_value_div_vendor_'+id).style.display == "block"){
      decr1 = id-1;
      document.getElementById("vendor"+id).value="";
                                                  ...
                                                  <div class="row">
                                                       <div class="col-sm-6">
                                                            <div class="form-group">
                                                              ...
                                                              <input type="text" name="assy_instruction" class="form-control" value="{{$product->assy_instruction}}">
                                                              @if (!empty($errors))
                                                       ...
                                                       <div class="col-sm-6">
                                                            <div class="form-group">
                                                              ...
                                                              <input type="text"  name="literature" class="form-control" value="{{$product->literature}}">
                                                              @if (!empty($errors))
                                                       ...
                                                       <div class="col-sm-3">
                                                            <div class="form-group">
                                                              ...
                                                              <img src="{{url('assets2/image-1')}}/{{$product->image1}}" width="100px" height="90px">
                                                            </div>
                                                       </div>
                                                       <div class="col-sm-3">
                                                            <div class="form-group">
                                                              ...
                                                              <img src="{{url('assets2/image-2')}}/{{$product->image2}}" width="100px" height="90px">
                                                            </div>
                                                       </div>
                                                       <div class="col-sm-3">
                                                            <div class="form-group">
                                                              ...
                                                              <img src="{{url('assets2/image-3')}}/{{$product->image3}}" width="100px" height="90px">
                                                            </div>
                                                       </div>
                                                       <div class="col-sm-3">
                                                            <div class="form-group">
                                                              ...
                                                              <img src="{{url('assets2/image-4')}}/{{$product->image4}}" width="100px" height="90px">
                                                            </div>
                                                       </div>
                                                ...
                                                <div class="card-body" id="demo">
                                                  ...
                                                  <div class="col-sm-6">
                                                            <div class="form-group">
                                                              ...
                                                              <textarea class="form-control" name="old_feature">{{$product->old_feature}}</textarea>
                                                              @if (!empty($errors))
                                                       ...
                                                       <div class="col-sm-6">
                                                            <div class="form-group">
                                                              ...
                                                              <textarea class="form-control" name="new_feature">{{$product->new_feature}}</textarea>
                                                              @if (!empty($errors))
                                                       ...
                                                       <div class="col-sm-12">
                                                            <div class="form-group">
                                                              ...
                                                              <textarea class="form-control" name="remarks">{{$product->remarks}}</textarea>
                                                              @if (!empty($errors))
...
<!-- ************************************************************************************************************************************ -->
                        ...
                        foreach($amit as $val){ 
                            $j = $val->id;
                        ?>      
                        <div id="attributes_value_div_pdf_heading_<?=$val->id?>" >
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                
                                <label for="inputName">HEAD</label>
                                    <input type="text" class="form-control" value="{{$val->master_drawing_data}}" name="master_drawing_data<?=$j?>" id="master_drawing_data<?=$j?>" multiple>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                <label for="inputName">DETAILS</label>
                                    <input type="text" class="form-control" value="{{$val->master_drawing_data_details}}" name="master_drawing_data_details<?=$j?>" id="master_drawing_data_details<?=$j?>" multiple>
                                </div>
                                </div>
                                ...
                                <label for="inputName">IMAGE UPLOAD</label>
                                    <input type="file" class="form-control" name="master_drawing_data_file<?=$j?>" id="master_drawing_data_file<?=$j?>" multiple>
                                    <div>{{$val->master_drawing_data_file}}</div>
                                </div>
                                </div>

                                <?php  if($j!=1){ ?>
                                <div class="col-sm-2" id="cancel_3_<?=$j?>" style="display:block;">
                                                ...
                                                <div id="showitinerary">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-sm-6">
                                                          ...
                                                          <input type="text" name="alias1" class="form-control" value="{{$product->alias1}}">
                                                          @if (!empty($errors))
...
<!-- *********************************************************************************************************************************************** -->
                                          <div class="card card-primary my-3">
                                             <div class="card-body" id="demo">
                                                  <div class="row">
                                                      ...
                                                      <div class="row">
                                                       <div class="col-sm-8">
                                                        <div class="form-group">
                                                          <input type="text" class="form-control" name="bom_item<?=$j?>" id="bom_item<?=$j?>">
                                                        </div>
                                                        </div>
                                             ...
                                             <?php $j=1;
                                            foreach($bomItem as $key){ 
                                                $j = $key->id;
                                            ?> 
                                            <!-- <div class="container"> -->
                                            <div id="attributes_value_div_bom_item_<?=$key->id?>" >
                                             <div class="row">
                                                <div class="col-sm-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" value="{{$key->bom_item}}" name="bom_item<?=$j?>" id="bom_item<?=$j?>" multiple>
                                                </div>
                                                </div>

                                                <?php if($j!=1){ ?>
                                                <div class="col-sm-2" id="cancel_3_<?=$j?>" style="display:block;">
                                                <button type="button" onclick="return del_more_bom_item1('attributes','<?=$j?>');" class="btn btn-danger mt-0 d-inline-block">
                                                    Remove
                                                </button>
                                                </div>            
                                                 <?php }?>
...
<!-- *********************************************************************************************************************************************** -->
                                          <div class="card card-primary my-3">
                                             <div class="card-body" id="demo">
                                                  ...
                                                  <div class="row">
                                                      ...
                                                      <div class="row">
                                                       <div class="col-sm-8">
                                                        <div class="form-group">
                                                          <input type="text" class="form-control" name="vendor<?=$j?>" id="vendor<?=$j?>">
                                                        </div>
                                                        </div>
                                            ...
                                            foreach($vendor as $key){ 
                                                $j = $key->id;
                                            ?> 
                                             <div id="attributes_value_div_vendor_<?=$key->id?>" >
                                             <div class="row">
                                                <div class="col-sm-8">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" value="{{$key->vendor}}" name="vendor<?=$j?>" id="vendor<?=$j?>">
                                                </div>
                                                </div>

                                                <?php if($j!=1){ ?>
                                                <div class="col-sm-2" id="cancel_3_<?=$j?>" style="display:block;">
                                                <button type="button" onclick="return del_more_vendor1('attributes','<?=$j?>');" class="btn btn-danger mt-0 d-inline-block">
                                                    Remove
                                                </button>
                                                </div>            
                                            <?php }?>
...
<!-- <script src="https://cdn.ckeditor.com/4.14.1/standard/ckeditor.js"></script>
  <script>
    CKEDITOR.replace('packageoverview');
