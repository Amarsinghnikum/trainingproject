                ...
                <div class="col-xs-6" style="border:0px solid gray">
                    ...
                    <label for=""></label>
                        ...
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-4 col-form-label" style="color:#666;">OLD FEATURES :</label>
                            <div>
                                <b>{{$productimage->old_feature}}</b>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-4 col-form-label" style="color:#666;">NEW FEATURES :</label>
                            <div>
                                <b>{{$productimage->new_feature}}</b>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-4 col-form-label" style="color:#666;">REMARKS :</label>
                            <div>
                                <b>{{$productimage->remarks}}</b>
                            </div>
                        </div>
                    </div> 
                </div>
